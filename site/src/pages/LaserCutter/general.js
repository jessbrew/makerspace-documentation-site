import '../../css/laser_cutter/general.css'
...
function Steps() {
    return (
        <ol>
            ...
            <Image src="images/laser_cutter/getting_started/createAccount1.jpg" rounded fluid></Image>
            <Image src="images/laser_cutter/getting_started/createAccount2.jpg" rounded fluid></Image>
            <li>
            ...
            <ul>
                ...
                <Image src="images/laser_cutter/getting_started/Illustrator1.jpg" rounded fluid></Image>
                <Image src="images/laser_cutter/getting_started/Illustrator2.jpg" rounded fluid></Image>
                <Image src="images/laser_cutter/getting_started/Illustrator3.jpg" rounded fluid></Image>
                <li>
                ...
                <Image src="images/laser_cutter/getting_started/Showgrid.jpg" rounded fluid></Image>
            </ul>
            <li>
            ...
            <Image src="images/laser_cutter/getting_started/PrintSetup.jpg" rounded fluid></Image>
            <ul>
                <li>
                    This brings up a Windows pop-up that you click the preferences button
                </li>
            </ul>
            <Image src="images/laser_cutter/getting_started/PrintSetup2.jpg" rounded fluid></Image>
            <ul>
                <li>
            ...
            <Image src="images/laser_cutter/getting_started/MaterialSelection.jpg" rounded fluid></Image>
            <li>
            ...
            <Image src="images/laser_cutter/getting_started/FindUCP.jpg" rounded fluid></Image>
            <Image src="images/laser_cutter/getting_started/UCPBasicScreen.jpg" rounded fluid></Image>
            <li>
            ...
            <ul>
                ...
                <Image src="images/laser_cutter/getting_started/Ucprightcolumn1.jpg" rounded fluid></Image>
                <li>
                ...
                <Image src="images/laser_cutter/getting_started/UCPTab1.jpg" rounded fluid></Image>
                <Image src="images/laser_cutter/getting_started/UCPTab2.jpg" rounded fluid></Image>
                <Image src="images/laser_cutter/getting_started/UCPTab3.jpg" rounded fluid></Image>
                <Image src="images/laser_cutter/getting_started/UCPTab4.jpg" rounded fluid></Image>
            </ul>
        </ol>
    );
}